...
const carouselData = [
  {
    ...
    title: "",
    description:
      "서울, 경기 지역의 반려동물 병원 · 약국 위치 및 정보부터  \n동반 가능 카페, 숙소 등 다양한 서비스까지 \n 한 눈에 확인하고,보호자들과 소통하는 커뮤니티까지\n  ",
  ...
  },
  {
    ...
    description:
      "반려동물의 건강을 위해! 펫메디에서 내 주변 동물병원과 \n 약국 정보를 지도에서 편리하게 확인하고, \n 위치와 운영시간까지 한 번에 찾아보세요.",
